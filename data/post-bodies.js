...
export const BODIES = {
  ...
  "menyusun-rute-sendiri": [
    ...
    { figure: "/assets/peta-gua-maria-jawa.webp", ratio: "16 / 9",
      caption: "Sebelas gua Maria di Jawa, dari Cianjur sampai Banyuwangi. Peta seperti ini berguna untuk melihat jarak sebenarnya — bukan untuk dijadikan rute. Rangkaian ini kalau dikerjakan sekaligus melanggar hampir semua aturan di bawah: Jakarta–Banyuwangi lewat sebelas titik butuh lebih dari seminggu, dan tidak ada satu titik pun yang kebagian sembilan puluh menit." },
