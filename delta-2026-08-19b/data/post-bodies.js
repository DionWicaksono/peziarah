...
export const BODIES = {
  ...
  "muntilan-orang-yang-memulai": [
    ...
    { p: "Frans van Lith, imam Yesuit Belanda, datang ke Muntilan pada 1896. Yang ia temukan adalah pekerjaan misi yang jalan di tempat: sedikit orang Jawa yang tertarik, dan kebanyakan yang tertarik pun mendekat karena alasan praktis, bukan karena percaya." },
    ...
    { figure: "", slot: "[ foto: koleksi museum misi muntilan ]",
      caption: "Ruang koleksi. Sebagian benda datang dari paroki yang sudah tidak memakainya lagi." },
  ...
  "gua-maria-kerep-ambarawa": [
    ...
    { figure: "", slot: "[ foto: gua maria kerep ambarawa ]",
      caption: "Kompleks Kerep di pagi hari kerja. Sebelum jam delapan, jalan salibnya praktis kosong." },
