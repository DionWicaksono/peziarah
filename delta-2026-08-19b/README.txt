...
(biasanya public_html/). Struktur akhirnya:
  ...
  public_html/
    ...
    produk/<id>/index.html    -> /produk/<id>/        (36 halaman produk)
    ...
    jurnal/artikel/<slug>/    -> /jurnal/artikel/<slug>/  (3 artikel yang sudah ditulis)
...
- Halaman utama (/, /katalog/), 36 halaman produk, 6 halaman rute
  (/ziarah/rute/<slug>/), dan 12 artikel jurnal sudah di-prerender: isinya
  tertulis langsung di HTML, jadi Google membacanya tanpa JavaScript.
  Halaman lain masih dirender di browser.
...
HALAMAN PRODUK, RUTE & ARTIKEL SUDAH DI-PRERENDER
...
File Manager, katalog langsung berubah TAPI 36 halaman produk masih memuat
...
- Nomor WhatsApp (wa.me/6281200000000) di semua halaman.
- Rekening bank di /keranjang/ dan /faq/.
- Link WhatsApp di footer masih "#" (menunggu nomor asli).
- Halaman Kebijakan Privasi & Syarat Ketentuan (link masih #).
- Empat kiriman "Cerita Iman" masih tampil sebagai kartu saja (belum
  jadi halaman artikel) — sesuai rencana.
